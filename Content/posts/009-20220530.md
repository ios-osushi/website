...
6月30日以降、アカウント作成に対応しているアプリは [App Store Review ガイドライン 5.1.1(v)](https://developer.apple.com/jp/app-store/review/guidelines/#5.1.1v) に従い、ユーザー自身がアプリ内でアカウントを削除できるようにする必要があります。
