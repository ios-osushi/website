...
description: try! Swift Tokyo 再始動、iOSDC Japan 2022 開催日変更、Swift 5.6.2 リリース、The Composable Architecture 0.37.0 リリース、Firebase Apple SDK 9.2.0 リリース、SwiftFormat 0.49.11 リリースなど
tags: apple, swift, ios, ipados, macos, watchos, tvos, xcode, testflight, try-swift-tokyo, iosdcjapan, swift-async-algorithms, tca, the-composable-architecture, firebase, swiftformat
---
# 013 2022-06-27
