...
GitHub Actions の Ubuntu 18.04 環境では[イメージバージョン 20220316.1 で Swift 5.6 が利用可能になっていました](https://github.com/actions/virtual-environments/pull/5248)。
Ubuntu 20.04 環境でも[イメージバージョン 20220330.0 で Swift 5.6 が利用可能になりました](https://github.com/actions/virtual-environments/pull/5314)。
